...
## 🔎 Detection Examples
- Splunk SPL queries for detecting unusual NTLM authentications
- Security Onion Suricata rules for suspicious SMB traffic
- Wireshark captures of poisoned LLMNR requests

## 📂 Repository Structure
- `/splunk-queries/` → SPL queries
- `/suricata-rules/` → Custom rules
- `/pcaps/` → Sample Wireshark captures (redacted)
